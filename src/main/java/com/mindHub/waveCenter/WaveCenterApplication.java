...
//            standRepository.save(bigStand);
            ...
            Event eventCreativeCurrent = new Event("The Creative Current", "Immerse yourself in a creative fair that celebrates local talent. Artists from various disciplines will display their works, from stunning sculptures to vibrant digital illustrations. Interact with the creators, discover their process and acquire unique pieces that reflect the artistic diversity of the community. An unmissable experience for art lovers!", Arrays.asList("Sofía Martínez - Painter known for her vibrant abstract landscapes.", "Diego Ruiz - Sculptor who works with recycled materials, creating unique and sustainable works.", "Valeria Gómez - Digital illustrator who combines traditional and digital techniques to tell visual stories."), LocalDate.of(2024, 11, 6), 1000.0, Arrays.asList("../assets/aCreative1.jpg", "../assets/aCreative2.jpg", "../assets/aCreative3.png", "../assets/aCreative4.png", "../assets/aCreative5.jpg"));
...
//            eventInnovatorsHaven.addStand(smallStand);
//            eventInnovatorsHaven.addStand(bigStand);
...
//            eventCulturalMarket.addStand(smallStand);
//            eventCulturalMarket.addStand(bigStand);
...
//            eventHeroesSummit.addStand(smallStand);
//            eventHeroesSummit.addStand(bigStand);
...
//            eventCulinaryFest.addStand(smallStand);
//            eventCulinaryFest.addStand(bigStand);
